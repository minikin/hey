...
final class SignInCoordinator: Coordinator {
    ...
    func start(animated: Bool, completion: VoidClosure?) {
        ...
        baseController.present(singInViewController!, animated: animated, completion: completion)
    }
...
extension SignInCoordinator: SignInViewControllerDelegate {
    func signInViewController(_: SignInViewController, didNotify action: SignInViewController.Action) {
        switch action {
